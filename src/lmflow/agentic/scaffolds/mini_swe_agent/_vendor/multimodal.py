"""Vendored mini-swe-agent utilities for OpenAI-style multimodal messages."""
...
def expand_multimodal_content(content: Any, *, pattern: str) -> Any:
    """Recursively expand multimodal tags without mutating the input."""
    if not pattern:
        return content
...
__all__ = ["DEFAULT_MULTIMODAL_REGEX", "expand_multimodal_content"]
