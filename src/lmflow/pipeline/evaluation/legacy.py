"""Legacy accuracy, perplexity, and negative-log-likelihood implementation."""
...
class LegacyEvaluatorMixin:
    """Implementation detail used by :class:`Evaluator` for old scalar metrics."""
    ...
    def _evaluate_nll(
        ...
        encoding_list = [
            ...
            for input_ids, labels in zip(tokenized_dataset["input_ids"], tokenized_dataset["labels"], strict=False)
        ]
